...
| 시간        | 내용                                                                   | 유형      |
|-------------|------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 왜 갭을 "찾기"만으로는 부족한가 (단발 펜테스트 vs 퍼플 사이클)    | 강의      |
| 0:20–0:50   | 이론 — Purple Team 4 단계(에뮬레이션→측정→보강→재검증) + 본 주차 기법    | 강의      |
| 0:50–1:00   | 휴식                                                                    | —         |
| 1:00–1:30   | 이론 — Wazuh 탐지 파이프라인(decoder→rule) + logtest 무중단 검증 원리     | 강의/토론 |
| 1:30–2:00   | 실습 — 점검 + ① 갭 재현(T1087 에뮬) + ② 커버리지 측정(logtest) (lab 1–3)  | 실습      |
| 2:00–2:30   | 실습 — ③ 갭 보강 룰(101414) + logtest + 원복 (lab 4)                     | 실습      |
| 2:30–2:40   | 휴식                                                                    | —         |
| 2:40–3:10   | 실습 — ④ 재검증(❌→✅) + 커버리지 매트릭스 (lab 5–6)                      | 실습      |
| 3:10–3:30   | 실습 — 퍼플 사이클 정리 + 커버리지 보고서 (lab 7–8)                      | 실습      |
| 3:30–3:40   | 정리 + 다음 주차(W15 — 캡스톤 PTES 완주) 예고                           | 정리      |
