...
# 경로 퍼징 (juice vhost)
printf "admin\nlogin\nftp\n" > /tmp/pt15.txt; ffuf -u http://192.168.0.161/FUZZ -w /tmp/pt15.txt -H "Host: juice.el34.lab" -mc 200,301,403 -s 2>&1 | head -5; rm -f /tmp/pt15.txt
```
...
curl -s -o /dev/null -w 'sqli=%{http_code} ' -A sqlmap/1.7 -H 'Host: dvwa.el34.lab' \"http://192.168.0.161/?id=pt15%27%20UNION%20SELECT%201--\"
