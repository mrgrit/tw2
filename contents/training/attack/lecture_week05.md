...
curl -s -o /dev/null -w 'img=%{http_code}\n' 'http://dvwa.el34.lab/?q=<img%20src=x%20onerror=alert(1)>'
curl -s -o /dev/null -w 'svg=%{http_code}\n' 'http://dvwa.el34.lab/?q=<svg%20onload=alert(1)>'
```
...
curl -s -o /dev/null -w 'enc=%{http_code}\n' 'http://dvwa.el34.lab/?q=%3Cscript%3Ealert(1)%3C/script%3E'
```
...
curl -s -o /dev/null -w 'dvwa=%{http_code} ' 'http://dvwa.el34.lab/?q=<script>alert(1)</script>'
