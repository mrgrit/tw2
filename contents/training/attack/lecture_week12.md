...
| 시간        | 내용                                                                  | 유형     |
|-------------|-----------------------------------------------------------------------|----------|
| 0:00–0:20   | 이론 — 침투 한 번을 "상태"로 바꾸는 지속성, 왜 다중인가 (ATT&CK TA0003) | 강의     |
| 0:20–0:55   | 이론 — 다섯 persistence 벡터(계정·cron·SSH키·SUID·systemd) 상세        | 강의     |
| 0:55–1:05   | 휴식                                                                   | —        |
| 1:05–1:35   | 이론 — 안티포렌식 3축 + 그 구조적 한계(중앙 수집 앞에서 무력)          | 강의/토론 |
| 1:35–2:00   | 실습 — 점검(osquery) + 다중 persistence 심기 (lab 1–2)                 | 실습     |
| 2:00–2:30   | 실습 — 안티포렌식 시도 + 전수 헌팅(osquery) (lab 3–4)                  | 실습     |
| 2:30–2:40   | 휴식                                                                   | —        |
| 2:40–3:10   | 실습 — 로그 무결성(중앙 수집/FIM) + 전수 제거(self-clean) (lab 5–6)    | 실습     |
| 3:10–3:30   | 실습 — 방어 종합(전수 헌팅 + 불변 로그) + persistence 보고서 (lab 7–8) | 실습     |
| 3:30–3:40   | 정리 + 다음 주차(W13 — MITRE Caldera 자동 에뮬레이션) 예고             | 정리     |
