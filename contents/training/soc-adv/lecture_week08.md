...
| 시간        | 내용                                                                | 유형      |
|-------------|---------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 왜 메모리인가, 디스크 vs 메모리, 파일리스 위협                | 강의      |
| 0:25–0:55   | 이론 — /proc 구조(cmdline·environ·exe·maps·fd)                      | 강의      |
| 0:55–1:05   | 휴식                                                                 | —         |
| 1:05–1:35   | 이론 — 은닉 프로세스 탐지·휘발성 순서                                | 강의/토론 |
| 1:35–2:10   | 실습 — cmdline·environ + exe 복원                                    | 실습      |
| 2:10–2:40   | 실습 — maps/fd + /proc vs ps 교차 비교                               | 실습      |
| 2:40–2:50   | 휴식                                                                 | —         |
| 2:50–3:20   | 실습 — 휘발성 순서 + 보고서                                          | 실습      |
