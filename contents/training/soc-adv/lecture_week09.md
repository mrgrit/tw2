...
| 시간        | 내용                                                                | 유형      |
|-------------|---------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 왜 분석하나(방어 위해), 정적 vs 동적                         | 강의      |
| 0:25–0:55   | 이론 — 정적 분석(해시·타입·문자열), YARA 분류                       | 강의      |
| 0:55–1:05   | 휴식                                                                 | —         |
| 1:05–1:35   | 이론 — 동적 행위 지표·안전한 검체 취급                               | 강의/토론 |
| 1:35–2:10   | 실습 — 검체 준비 + 정적(해시·타입·문자열)                            | 실습      |
| 2:10–2:40   | 실습 — YARA 분류 + 동적 행위                                         | 실습      |
| 2:40–2:50   | 휴식                                                                 | —         |
| 2:50–3:20   | 실습 — 안전 취급/정리 + 보고서                                       | 실습      |
