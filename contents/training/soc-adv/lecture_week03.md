...
| 시간        | 내용                                                                | 유형      |
|-------------|---------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 왜 벤더 독립 표준인가(N번 다시 쓰기의 낭비), SIGMA 개요       | 강의      |
| 0:25–0:55   | 이론 — SIGMA 구조(logsource/detection/condition) 정독               | 강의      |
| 0:55–1:05   | 휴식                                                                 | —         |
| 1:05–1:35   | 이론 — 변환(여러 백엔드)·테스트·튜닝·ATT&CK 커버리지                 | 강의/토론 |
| 1:35–2:10   | 실습 — 소스 확인 + 구조 해석 + 룰 카탈로그                           | 실습      |
| 2:10–2:40   | 실습 — 다중 백엔드 변환 + 룰 테스트(logtest)                         | 실습      |
| 2:40–2:50   | 휴식                                                                 | —         |
| 2:50–3:20   | 실습 — 튜닝 + ATT&CK 커버리지 관리                                   | 실습      |
