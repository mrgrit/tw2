...
| 시간        | 내용                                                                | 유형      |
|-------------|---------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 수동 탐지 vs 능동 헌팅, 가설 기반 방법론                      | 강의      |
| 0:25–0:55   | 이론 — osquery(스냅샷) vs Sysmon(이벤트), 무엇을 사냥하나            | 강의      |
| 0:55–1:05   | 휴식                                                                 | —         |
| 1:05–1:35   | 이론 — IOC vs TTP 헌팅(피라미드 오브 페인), 헌팅 환류                | 강의/토론 |
| 1:35–2:10   | 실습 — 가설 수립 + 은닉 프로세스·리스너 헌팅                         | 실습      |
| 2:10–2:40   | 실습 — Sysmon 이벤트 헌팅 + IOC/TTP 구분                             | 실습      |
| 2:40–2:50   | 휴식                                                                 | —         |
| 2:50–3:20   | 실습 — 탐지룰 환류 + 보고서                                          | 실습      |
