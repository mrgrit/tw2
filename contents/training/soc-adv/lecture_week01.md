...
| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 왜 "문서 성숙도"가 아니라 "탐지 성숙도"인가, SOC-CMM 5도메인         | 강의      |
| 0:25–0:55   | 이론 — 가시성 4계층(웹·네트워크·호스트·SIEM)과 각 계층의 증거               | 강의      |
| 0:55–1:05   | 휴식                                                                        | —         |
| 1:05–1:35   | 이론 — 가시성 정량화·갭 분석·개선 로드맵 방법론                             | 강의/토론 |
| 1:35–2:05   | 실습 — 대상 도달 + 웹 가시성(SQLi→ModSec) + 네트워크 가시성(Suricata)       | 실습      |
| 2:05–2:35   | 실습 — SIEM 가시성(Wazuh) + 호스트 가시성(osquery)                          | 실습      |
| 2:35–2:45   | 휴식                                                                        | —         |
| 2:45–3:20   | 실습 — SOC-CMM 평가 + 갭 분석·로드맵                                        | 실습      |
| 3:20–3:40   | 정리 + 성숙도 보고서 + 다음 주차 예고                                       | 정리      |
