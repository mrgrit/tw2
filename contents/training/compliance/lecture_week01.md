...
3. el34 호스트(`ssh ccc@192.168.0.151`)에서 점검 대상 컨테이너(`el34-web`)에 `docker exec` 로
...
| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 컴플라이언스란 무엇인가, 보안 점검과 어떻게 다른가(감사자 관점)      | 강의      |
| 0:25–1:00   | 이론 — 주요 프레임워크 4종(ISMS-P / ISO 27001 / PCI-DSS / NIST CSF) 상세   | 강의      |
| 1:00–1:10   | 휴식                                                                        | —         |
| 1:10–1:40   | 이론 — 통제의 두 축(관리/물리/기술 · 예방/탐지/교정) + 심층 방어            | 강의/토론 |
| 1:40–2:10   | 실습 — el34 점검 대상 확정 + 프레임워크/통제 식별 (lab 1–3)                 | 실습      |
| 2:10–2:40   | 실습 — 기술 점검(ServerTokens) + 갭 분석 (lab 4–5)                          | 실습      |
| 2:40–2:50   | 휴식                                                                        | —         |
| 2:50–3:20   | 실습 — 증적 요건 + 3축 점검 방법론 (lab 6–7)                                | 실습      |
| 3:20–3:35   | 실습 — 컴플라이언스 개요 보고서 종합 (lab 8)                                | 실습      |
| 3:35–3:40   | 정리 + 다음 주차(W02 — 보안 정책/거버넌스) 예고                             | 정리      |
...
graph TD
    ...
    HOST["el34 호스트<br/>ssh ccc@192.168.0.151 (pw 1)"]
