...
본 주차는 새 도구를 설치하지 않는다. 이미 el34 에 가동 중인 로깅 체계를 **감사자 관점에서 점검·평가**
하는 데 시간을 쓴다.

| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 왜 "로그 없는 보안"은 감사에서 탈락하는가 (실 사례)                  | 강의      |
| 0:20–0:45   | 이론 — PCI-DSS 요구사항 10 전체 지도 + ISMS-P 2.9 매핑                      | 강의      |
| 0:45–0:55   | 휴식                                                                        | —         |
| 0:55–1:20   | 이론 — 감사 추적 5요소 + 무결성·보존·시간동기화 + 로그 수명주기            | 강의/토론 |
| 1:20–1:50   | 실습 — 점검(대상) + 로그 활성(Apache) + 중앙 수집(Wazuh) (lab 1–3)         | 실습      |
| 1:50–2:00   | 휴식                                                                        | —         |
| 2:00–2:20   | 실습 — 감사요소·무결성·보존·NTP·방어·보고 (lab 4–8) + 다음 주차 예고       | 실습/정리 |
...
## 0.5 신입생 친화 핵심 개념 — "왜 로그가 보안의 마지막 보루인가"
