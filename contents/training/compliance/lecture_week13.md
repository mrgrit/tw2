...
```bash
ssh ccc@10.20.32.80 'apache2 -v | head -1; openssl version; echo "components=$(dpkg -l | grep -ciE "apache2|openssl|libssl")"'
```
...
>
> **무엇을 알 수 있는가?** `ssh ccc@10.20.32.80` 으로 hostname 이 응답하는지 — 공급망 점검 대상
