...
| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 왜 "공급망"이 가장 큰 사각지대인가 (실 사례 3건: Log4Shell·SolarWinds·Magecart) | 강의 |
| 0:25–0:55   | 이론 — 공급망 위험 3 갈래 + SBOM 이라는 출발점                              | 강의      |
| 0:55–1:05   | 휴식                                                                        | —         |
| 1:05–1:35   | 이론 — 외부 의존성(CDN)과 무결성(SRI) · 버전→CVE 매핑 · 제3자 위험 평가     | 강의/토론 |
| 1:35–2:00   | 실습 — 점검(대상 도달) + 소프트웨어 구성 식별(SBOM 기초) (미션 1–2)         | 실습      |
| 2:00–2:30   | 실습 — 외부 의존성(Google Fonts CDN) + 버전→CVE 매핑 (미션 3–4)             | 실습      |
| 2:30–2:40   | 휴식                                                                        | —         |
| 2:40–3:10   | 실습 — 제3자 위험 평가 + 공급망 통제(SBOM/SRI/실사) (미션 5–6)              | 실습      |
| 3:10–3:30   | 실습 — 공급망 보안 방어 + 공급망 위험 보고서 (미션 7–8)                     | 실습      |
| 3:30–3:40   | 정리 + 채점 기준 안내 + 다음 주차(W14 — 감사·증적 수집) 예고                | 정리      |
...
해석(정상 vs 비정상) / 실전 활용. 모든 명령은 el34 호스트(`ssh ccc@192.168.0.151`, 비밀번호 1)에서
