...
| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 왜 접근통제가 "가장 자주 깨지는 통제"인가 (실 사고 3건)             | 강의      |
| 0:20–0:55   | 이론 — 접근통제 4단계 + PCI-DSS 7·8 / ISMS-P 2.5 / CIS 매핑                | 강의      |
| 0:55–1:05   | 휴식                                                                        | —         |
| 1:05–1:30   | 이론 — 감사자의 시선: 증거 기반 점검과 갭 판정 + el34-web 진입 경로 재확인 | 강의/토론 |
| 1:30–2:00   | 실습 — 점검(도달성) + 계정 식별(UID0) (lab 1–2)                            | 실습      |
| 2:00–2:30   | 실습 — 암호 정책(PASS_MAX_DAYS) + 파일 권한(shadow/sudoers) (lab 3–4)      | 실습      |
| 2:30–2:40   | 휴식                                                                        | —         |
| 2:40–3:10   | 실습 — 최소권한·직무분리 + 갭 도출 (lab 5–6)                               | 실습      |
| 3:10–3:30   | 실습 — 방어 권고 + 접근통제 감사 보고서 (lab 7–8)                          | 실습      |
| 3:30–3:40   | 정리 + 채점 기준 안내 + 다음 주차(W05 — 암호화 컴플라이언스) 예고          | 정리      |
