...
| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 왜 취약점은 "관리"의 대상인가: 일회성 점검의 실패 사례                | 강의      |
| 0:20–0:55   | 이론 — 취약점 관리 순환 5단계 + PCI-DSS 11·6 매핑                          | 강의      |
| 0:55–1:05   | 휴식                                                                        | —         |
| 1:05–1:35   | 이론 — 정기성·위험도 분류·패치 SLA·보상 통제(가상패치)                     | 강의/토론 |
| 1:35–2:05   | 실습 — 점검(도달성) + ① 정기 스캔(nuclei, PCI 11) (lab 1–2)                | 실습      |
| 2:05–2:35   | 실습 — ② 결과 분류(severity) + ③ 패치 SLA(PCI 6) (lab 3–4)                 | 실습      |
| 2:35–2:45   | 휴식                                                                        | —         |
| 2:45–3:15   | 실습 — ④ 관리 순환 + ⑤ 보상 통제(가상패치) (lab 5–6)                       | 실습      |
| 3:15–3:30   | 실습 — 방어(프로세스 제도화) + 취약점 관리 보고서 (lab 7–8)                | 실습      |
