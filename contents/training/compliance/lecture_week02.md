...
| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 통제는 어디서 오는가: 정책이 모든 통제의 뿌리인 이유 + 실패 사례     | 강의      |
| 0:20–0:55   | 이론 — 정책 위계 4단(정책>지침>절차>기준) 상세 + 하나의 요구사항 분해 실습  | 강의      |
| 0:55–1:05   | 휴식                                                                        | —         |
| 1:05–1:35   | 이론 — 거버넌스 R&R(경영진~담당자) + ISMS-P 1.1 + 책임 매핑                 | 강의/토론 |
| 1:35–2:05   | 실습 — 점검(도달성) + 정책 위계 정리 + 거버넌스 R&R 정리 (lab 1–3)         | 실습      |
| 2:05–2:35   | 실습 — **정책의 기술적 강제 점검: el34-web PermitRootLogin** (lab 4)        | 실습      |
| 2:35–2:45   | 휴식                                                                        | —         |
| 2:45–3:15   | 실습 — 정책 생명주기 + 준수 점검(정책↔시행 대조) (lab 5–6)                 | 실습      |
| 3:15–3:30   | 실습 — 거버넌스 종합 + 정책/거버넌스 보고서 (lab 7–8)                       | 실습      |
| 3:30–3:40   | 정리 + 채점 기준 안내 + 다음 주차(W03 — 자산 식별·분류) 예고               | 정리      |
