...
중간고사는 시험이지만, 본 강의 시간은 시험 직전의 **종합 복습 + 분석 프레임워크 정립 + 실기
평가**로 구성한다.

| 시간        | 내용                                                                   | 유형      |
|-------------|------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 왜 한 로그만으로는 공격 서사가 안 보이는가 (교차 분석의 동기)     | 강의      |
| 0:20–0:50   | 이론 — 종합 분석 5단계(수집→상관→매핑→서사→판정) + 네 소스 매핑          | 강의      |
| 0:50–1:00   | 휴식                                                                    | —         |
| 1:00–1:30   | 이론 — 출처 IP 보존이 왜 상관의 키인가 + ATT&CK 서사 작성법              | 강의/토론 |
| 1:30–2:00   | 실기 — 점검(네 소스) + 다단계 공격 재현 + 네트워크 분석 (lab 1–3)        | 시험      |
| 2:00–2:30   | 실기 — 웹 분석(ModSec/access) + 인증 분석(auth.log) (lab 4–5)            | 시험      |
| 2:30–2:40   | 휴식                                                                    | —         |
| 2:40–3:10   | 실기 — SIEM 수렴 + 교차 상관 + ATT&CK 서사 (lab 6–8)                     | 시험      |
| 3:10–3:30   | 실기 — 우선순위/에스컬레이션 + 침투 판정 + 종합 보고서 (lab 9–10)        | 시험      |
| 3:30–3:40   | 정리 + 채점 기준 안내 + 다음 주차(W09 — IR 첫 60분) 예고                 | 정리      |
