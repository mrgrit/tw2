...
| 시간 | 내용 | 유형 |
|------|------|------|
| 0:00–0:25 | 이론 — 왜 경보를 "단계"로 읽는가 (흩어진 경보의 함정) | 강의 |
| 0:25–1:00 | 이론 — MITRE ATT&CK 매트릭스: 전술·기술·TTP·kill chain | 강의 |
| 1:00–1:10 | 휴식 | — |
| 1:10–1:40 | 이론 — 캠페인 재구성(시간순+출발지 상관) + 다소스 상관 | 강의 |
| 1:40–2:05 | 실습 1, 2 — 텔레메트리 점검 + 공격 체인 재현 | 실습 |
| 2:05–2:35 | 실습 3, 4 — ATT&CK 매핑 + 캠페인 재구성 | 실습 |
| 2:35–2:45 | 휴식 | — |
| 2:45–3:15 | 실습 5, 6 — ModSec 심층 + Suricata 심층(다소스 입증) | 실습 |
| 3:15–3:30 | 실습 7 — P1~P4 에스컬레이션 판정 | 실습 |
| 3:30–3:40 | 실습 8 — 캠페인 분석 보고서 + 다음 주차 예고 | 정리 |
