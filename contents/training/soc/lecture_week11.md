...
| 시간        | 내용                                                                      | 유형      |
|-------------|---------------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 악성코드는 왜 집에 전화하나 (C2·비콘의 동기)                        | 강의      |
| 0:25–0:55   | 이론 — IOC 의 종류(네트워크/호스트)와 "재사용 가능한 지표"의 가치          | 강의      |
| 0:55–1:05   | 휴식                                                                      | —         |
| 1:05–1:35   | 이론 — 두 가시화 도구(osquery 스냅샷 vs Sysmon 이벤트) + Suricata 의 합주   | 강의/토론 |
| 1:35–2:00   | 실습 1, 2 — 가시성 점검 + 감염 재현(악성 프로세스 + C2 비콘)               | 실습      |
| 2:00–2:30   | 실습 3, 4 — IOC 추출(프로세스/연결) + 감염 범위 헌팅                       | 실습      |
| 2:30–2:40   | 휴식                                                                      | —         |
| 2:40–3:10   | 실습 5, 6 — Contain(C2 차단 룰 9511001) + Eradicate(악성코드 제거)          | 실습      |
| 3:10–3:30   | 실습 7, 8 — Recover + IOC 공유 + 악성코드 IR 보고서                         | 실습      |
| 3:30–3:40   | 정리 + 과제 안내 + 다음 주차(W12 — 내부 위협 UEBA) 예고                     | 정리      |
