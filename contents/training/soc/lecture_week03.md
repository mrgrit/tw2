...
| 시간        | 내용                                                              | 유형      |
|-------------|-------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 왜 한 공격을 세 로그로 봐야 하는가 (단일 로그의 함정)       | 강의      |
| 0:20–0:45   | 이론 — 세 로그 각각의 강점·한계 + ModSecurity / CRS 개념          | 강의      |
| 0:45–0:55   | 휴식                                                              | —         |
| 0:55–1:20   | 이론 — dvwa(차단) vs juice(DetectionOnly), 출처 IP 보존, 교차 상관 | 강의/토론 |
| 1:20–1:45   | 실습 1, 2 — 세 로그 위치 점검 + 웹 공격 재현                       | 실습      |
| 1:45–2:20   | 실습 3, 4, 5 — ModSec audit / Apache access / Suricata eve 분석    | 실습      |
| 2:20–2:30   | 휴식                                                              | —         |
| 2:30–2:55   | 실습 6, 7 — 세 로그 교차 상관 + Wazuh 수렴                         | 실습      |
| 2:55–3:00   | 실습 8 — 교차 분석 보고서 + 다음 주차 예고                         | 정리      |
