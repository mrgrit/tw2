...
| 시간        | 내용                                                                    | 유형      |
|-------------|-------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 가장 까다로운 위협: 왜 내부자는 시그니처로 안 잡히는가             | 강의      |
| 0:20–0:50   | 이론 — UEBA: baseline 대비 일탈 + 행위 네 축(시각·권한·파일·이동)        | 강의      |
| 0:50–1:00   | 휴식                                                                     | —         |
| 1:00–1:30   | 이론 — 유출 체인(접근→staging→전송) + 증거 보전이 왜 최우선인가          | 강의/토론 |
| 1:30–2:00   | 실습 — 점검 + 내부 위협 재현(sudo 남용 + staging) (lab 1–2)              | 실습      |
| 2:00–2:30   | 실습 — UEBA 식별 + staging 헌팅 (lab 3–4)                                | 실습      |
| 2:30–2:40   | 휴식                                                                     | —         |
| 2:40–3:10   | 실습 — 증거 보전(해시) + 유출 채널 격리 (lab 5–6)                        | 실습      |
| 3:10–3:30   | 실습 — 복구(staging 제거) + 내부 위협 IR 보고서 (lab 7–8)                | 실습      |
| 3:30–3:40   | 정리 + 다음 주차(W13 — 인텔 주도 트리아지) 예고                          | 정리      |
