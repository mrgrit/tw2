...
| 시간        | 내용                                                                    | 유형      |
|-------------|-------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 사람은 자지만 SOC 는 안 잔다 (야간·주말 위협 + 24/7 의 한계)      | 강의      |
| 0:20–0:55   | 이론 — Active Response 의 구조 (command + active-response + execd)       | 강의      |
| 0:55–1:05   | 휴식                                                                     | —         |
| 1:05–1:35   | 이론 — 자동화의 양날: 자가 DoS 와 세 안전장치 + SOAR 개념                | 강의/토론 |
| 1:35–2:05   | 실습 — 점검(데몬·설정) + 야간 위협 재현 + AR 설계 점검 (lab 1–3)         | 실습      |
| 2:05–2:35   | 실습 — 자동 대응 트리거 룰 설계 + logtest (lab 4)                        | 실습      |
| 2:35–2:45   | 휴식                                                                     | —         |
| 2:45–3:15   | 실습 — 안전장치 + AI 자율 트리아지 + 무인 효과 (lab 5–7)                 | 실습      |
| 3:15–3:30   | 실습 — 자동 대응 종합 보고서 (lab 8)                                     | 실습      |
| 3:30–3:40   | 정리 + 다음 주차(W15 — 기말: APT 캠페인 종합) 예고                       | 정리      |
