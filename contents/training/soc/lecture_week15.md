...
기말도 시험이지만, 본 강의 시간은 시험 직전의 **14주 통합 복습 + SOC 분석·대응 프레임워크
정립 + 실기 평가**로 구성한다.

| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — APT 란 무엇인가, 왜 분석만으로는 끝나지 않는가 (분석 + 대응 + 예방)   | 강의      |
| 0:20–0:55   | 이론 — 4 단계 킬체인 + 각 단계의 분석 소스·대응 매핑(14주 역량을 한 캠페인에) | 강의      |
| 0:55–1:05   | 휴식                                                                        | —         |
| 1:05–1:35   | 이론 — 출처 IP 보존(SNAT 없음)으로 4 단계를 한 캠페인으로 + 인텔 격상        | 강의/토론 |
| 1:35–2:00   | 실기 — 점검(전 도구) + APT 4 단계 재현 + 트리아지 (lab 1–3)                  | 시험      |
| 2:00–2:30   | 실기 — 네 소스 교차 분석 + ATT&CK 서사 (lab 4–5)                            | 시험      |
| 2:30–2:40   | 휴식                                                                        | —         |
| 2:40–3:10   | 실기 — IR 격리(sid 9515001) + 제거(osquery) + 인텔 격상(id 101515) (lab 6–8) | 시험      |
| 3:10–3:30   | 실기 — SIEM 수렴·출처 상관 + APT 종합 보고서 + 정리 확인 (lab 9–11)          | 시험      |
| 3:30–3:40   | 정리 + 수료 안내 + SOC 분석가로서의 다음 단계                               | 정리      |
...
호스트(`ssh ccc@192.168.0.151`, 비밀번호 1)에서 실행한다 — 컨테이너 작업은 `docker exec
