...
| 시간      | 내용                                                                    | 유형      |
|-----------|-------------------------------------------------------------------------|-----------|
| 0:00–0:25 | 이론 — 왜 탐지를 벤더마다 다시 쓰면 안 되는가 (SIGMA 의 동기)            | 강의      |
| 0:25–0:55 | 이론 — SIGMA 룰 YAML 구조 (logsource / detection / condition / tags)     | 강의      |
| 0:55–1:05 | 휴식                                                                    | —         |
| 1:05–1:35 | 이론 — 백엔드 변환의 원리 + sigma2wazuh 의 대응 규칙(keywords→regex 등)  | 강의/토론 |
| 1:35–2:00 | 실습 1, 2 — SIGMA 설정 점검 + web-sqli.yml 구조 읽기                     | 실습      |
| 2:00–2:30 | 실습 3, 4 — sigma2wazuh.py 변환 + wazuh-logtest 발화 검증                | 실습      |
| 2:30–2:40 | 휴식                                                                    | —         |
| 2:40–3:10 | 실습 5, 6 — Suricata 이식(개념) + 실제 SQLi → sigma 그룹 경보            | 실습      |
| 3:10–3:30 | 실습 7, 8 — 다중 플랫폼 가치 정리 + SIGMA 종합 보고서                    | 실습      |
| 3:30–3:40 | 정리 + 과제 안내 + 다음 주차(W08 중간고사) 예고                          | 정리      |
...
## 0.5 신입생 친화 핵심 개념 — "탐지는 레시피, 제품은 주방이다"
