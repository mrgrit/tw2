...
> **이번 주 한 줄 요약**
>
> WAF 장비의 **침해대응 훈련** 30개 SecRule 작성 시나리오를 푼다. 그리고 6주의 마무리로,
...
```mermaid
graph LR
    A[공격자<br/>ext 192.168.0.202<br/>sqlmap UA + SQLi] --> FW[방화벽<br/>conntrack 연결기록]
...
**여러분이 이제 할 수 있는 것:**
- 세 보안장비를 장비로 다루고, 각 동작이 만드는 **실제 명령**(nft / Suricata rule / SecRule)을 읽고 쓴다.
...
5. 모든 실습 룰을 **정리(cleanup)**했는지 세 장비에서 확인하고 캡처하세요.
