...
| 시간        | 내용                                                                | 유형      |
|-------------|---------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — AD의 중요성, 환경 스코핑                                     | 강의      |
| 0:25–0:55   | 이론 — AD 구조·열거·Kerberos                                        | 강의      |
| 0:55–1:05   | 휴식                                                                 | —         |
| 1:05–1:35   | 이론 — Kerberoast·AS-REP·BloodHound·장악                            | 강의/토론 |
| 1:35–2:10   | 실습 — 스코핑·구조·열거 방법론                                       | 실습      |
| 2:10–2:40   | 실습 — Kerberoast·AS-REP·BloodHound                                  | 실습      |
| 2:40–2:50   | 휴식                                                                 | —         |
| 2:50–3:20   | 실습 — 장악·방어 + 보고서                                            | 실습      |
