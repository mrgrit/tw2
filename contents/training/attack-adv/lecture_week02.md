...
| 시간        | 내용                                                                | 유형      |
|-------------|---------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 수동 vs 능동 정찰, OSINT의 힘                                | 강의      |
| 0:25–0:55   | 이론 — DNS·TLS/CT·핑거프린팅                                        | 강의      |
| 0:55–1:05   | 휴식                                                                 | —         |
| 1:05–1:35   | 이론 — WAF 탐지·노출 경로·표면 종합                                  | 강의/토론 |
| 1:35–2:10   | 실습 — DNS·인증서·핑거프린팅                                         | 실습      |
| 2:10–2:40   | 실습 — WAF 탐지·노출 경로                                            | 실습      |
| 2:40–2:50   | 휴식                                                                 | —         |
| 2:50–3:20   | 실습 — 표면 종합 + 보고서                                            | 실습      |
