...
| 시간        | 내용                                                                | 유형      |
|-------------|---------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 클라우드 공격은 설정 보안, 환경 스코핑                       | 강의      |
| 0:25–0:55   | 이론 — IMDS/SSRF·IAM 오설정                                         | 강의      |
| 0:55–1:05   | 휴식                                                                 | —         |
| 1:05–1:35   | 이론 — 스토리지·컨테이너 탈출·방어                                   | 강의/토론 |
| 1:35–2:10   | 실습 — 스코핑·IMDS·IAM·스토리지                                      | 실습      |
| 2:10–2:40   | 실습 — 컨테이너 탈출 벡터 실점검                                     | 실습      |
| 2:40–2:50   | 휴식                                                                 | —         |
