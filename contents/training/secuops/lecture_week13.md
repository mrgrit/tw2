...
| 시간      | 내용                                                                       | 유형      |
|-----------|----------------------------------------------------------------------------|-----------|
| 0:00–0:25 | 이론 — 정적 매칭(W12)의 한계와 "같은 경보, 다른 평결" (동적 우선순위의 동기) | 강의      |
| 0:25–0:55 | 이론 — enrichment 4 신호(평판·GeoIP·자산·빈도) + "지우지 않고 우선순위만"     | 강의      |
| 0:55–1:05 | 휴식                                                                       | —         |
| 1:05–1:35 | 이론 — frequency / timeframe / if_matched_sid + 평판 격상 룰 문법           | 강의/토론 |
| 1:35–2:00 | 실습 1, 2 — 상관 엔진·인텔 스택 점검 + 평판 격상 룰(101302) logtest           | 실습      |
| 2:00–2:30 | 실습 3, 4 — 반복 IOC 공격 + 빈도 격상 룰(101301) 다중 라인 logtest            | 실습      |
| 2:30–2:40 | 휴식                                                                       | —         |
| 2:40–3:10 | 실습 5, 6, 7 — 결합 우선순위 + 자동화(Stream Connector) + 반복 수렴           | 실습      |
| 3:10–3:30 | 실습 8, 9 — 종합 보고서 + 정리(베이스 보존) 확인                              | 실습      |
| 3:30–3:40 | 정리 + 과제 안내 + 다음 주차(W14) 예고                                       | 정리      |
