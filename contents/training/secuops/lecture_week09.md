...
| 시간      | 내용                                                                       | 유형      |
|-----------|----------------------------------------------------------------------------|-----------|
| 0:00–0:25 | 이론 — 왜 raw 로그는 그대로 쓸모가 적은가 (평결 파이프라인의 동기)          | 강의      |
| 0:25–0:55 | 이론 — Wazuh manager daemon 구조 + analysisd(심장) + 데이터 흐름            | 강의      |
| 0:55–1:05 | 휴식                                                                       | —         |
| 1:05–1:35 | 이론 — decoder / rule / level / group / 체이닝 / 커스텀 룰(local_rules.xml) | 강의/토론 |
| 1:35–2:00 | 실습 1, 2 — manager 심장 점검 + alerts.json 그룹 분포                       | 실습      |
| 2:00–2:30 | 실습 3, 4 — wazuh-logtest 3 phase + 커스텀 룰 격상                          | 실습      |
| 2:30–2:40 | 휴식                                                                       | —         |
| 2:40–3:10 | 실습 5, 6, 7 — ingest 추적 + agent localfile + 다소스 수렴                  | 실습      |
| 3:10–3:30 | 실습 8, 9 — 종합 보고서 + 정리(베이스 보존) 확인                            | 실습      |
| 3:30–3:40 | 정리 + 과제 안내 + 다음 주차(W10) 예고                                      | 정리      |
...
## 0.5 신입생 친화 핵심 개념 — "SIEM 은 창고가 아니라 법원이다"
