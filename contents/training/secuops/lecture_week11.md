...
| 시간      | 내용                                                                       | 유형      |
|-----------|----------------------------------------------------------------------------|-----------|
| 0:00–0:25 | 이론 — 스냅샷의 사각: 왜 단명 프로세스를 osquery 가 놓치는가                | 강의      |
| 0:25–0:55 | 이론 — 이벤트 스트림과 Sysmon for Linux(eBPF) + 3 EventID 구조              | 강의      |
| 0:55–1:05 | 휴식                                                                       | —         |
| 1:05–1:35 | 이론 — 왜 호스트에 설치했나(컨테이너 비특권) + base64 리버스셸 침해 사슬     | 강의/토론 |
| 1:35–2:00 | 실습 1, 2 — 호스트 sysmon 점검 + base64 페이로드 디코드                     | 실습      |
| 2:00–2:30 | 실습 3, 4 — ProcessCreate(1) vs osquery 대비 + NetworkConnect(3)            | 실습      |
| 2:30–2:40 | 휴식                                                                       | —         |
| 2:40–3:10 | 실습 5, 6, 7 — FileCreate(11) + persistence 계정 + 두 도구 역할 정리        | 실습      |
| 3:10–3:30 | 실습 8, 9 — 종합 보고서 + 정리(아티팩트 0, sysmon 유지)                     | 실습      |
| 3:30–3:40 | 정리 + 과제 안내 + 다음 주차(W12) 예고                                      | 정리      |
