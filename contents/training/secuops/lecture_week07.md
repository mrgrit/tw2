...
| 시간 | 내용 | 유형 |
|------|------|------|
| 0:00–0:25 | 이론 — 침해대응(IR)이란 무엇인가 + 엔드포인트가 마지막 안전망인 이유 | 강의 |
| 0:25–0:55 | 이론 — 두 페르소나(victim/analyst) + SOP 3단계(Triage→Investigate→Contain) | 강의 |
| 0:55–1:05 | 휴식 | — |
| 1:05–1:35 | 이론 — Linux 엔드포인트 핵심 텔레메트리 + osquery 테이블 ↔ 침해 신호 매핑 | 강의/토론 |
| 1:35–2:00 | 실습 1·2 — 텔레메트리 점검 + ep-s01(의심 다운로드) | 실습 |
| 2:00–2:30 | 실습 3·4 — ep-s02(인코딩 셸) + ep-s03(백도어 리스너) | 실습 |
| 2:30–2:40 | 휴식 | — |
| 2:40–3:10 | 실습 5·6 — ep-s04(백도어 계정) + ep-s05(persistence + Wazuh FIM) | 실습 |
| 3:10–3:30 | 실습 7·8 — JOIN 헌팅 조사 + SIEM 적재 확인 | 실습 |
| 3:30–3:40 | 실습 9·10 — IR 보고서 + self-clean + W08(중간고사) 예고 | 정리 |
