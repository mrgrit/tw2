...
| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 왜 "어디서·진짜인가"인가 (런타임 점검을 넘어 공급망으로)             | 강의      |
| 0:25–0:55   | 이론 — 레지스트리 + 이미지 다이제스트(sha256) = 불변 식별·무결성            | 강의      |
| 0:55–1:05   | 휴식                                                                        | —         |
| 1:05–1:35   | 이론 — 가변 태그 vs 불변 다이제스트 핀 + 레지스트리 신뢰·타이포스쿼팅       | 강의/토론 |
| 1:35–2:00   | 실습 — 이미지 목록(레지스트리) + 다이제스트 확인 (미션 1–2)                 | 실습      |
| 2:00–2:30   | 실습 — 가변 태그 vs 다이제스트 + 레지스트리 신뢰 (미션 3–4)                 | 실습      |
| 2:30–2:40   | 휴식                                                                        | —         |
| 2:40–3:10   | 이론/실습 — 이미지 서명(DCT/cosign·sigstore) + 방어 종합 (미션 5–6)         | 강의/실습 |
| 3:10–3:30   | 실습 — 레지스트리·이미지 신뢰 보고서 (미션 7)                               | 실습      |
| 3:30–3:40   | 정리 + 채점 기준 안내 + 다음 주차(W12 — 오케스트레이션 보안) 예고          | 정리      |
