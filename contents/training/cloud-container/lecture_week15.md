...
기말도 시험이지만, 본 강의 시간은 시험 직전의 **14주 통합 복습 + 감사 판단 프레임워크 정립 +
실기 평가** 로 구성한다.

| 시간        | 내용                                                                          | 유형      |
|-------------|-------------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 감사란 무엇인가, 왜 한 영역만 보면 안 되는가 (두 계층·8 영역 총정리)    | 강의      |
| 0:20–0:55   | 이론 — 14주의 점검을 한 대상에: 영역별 측정 명령과 준수/갭 판정 기준           | 강의      |
| 0:55–1:05   | 휴식                                                                          | —         |
| 1:05–1:35   | 이론 — 준수율 산정 + 위험 기반 시정 로드맵(무엇부터 고치나)                    | 강의/토론 |
| 1:35–2:00   | 실기 — 대상 식별 + ① 이미지 CVE + ② 특권 (lab 1–3)                            | 시험      |
| 2:00–2:30   | 실기 — ③ capability/user + ④ 시크릿 (lab 4–5)                                  | 시험      |
| 2:30–2:40   | 휴식                                                                          | —         |
| 2:40–3:10   | 실기 — ⑤ 격리 + ⑥ 네트워크 + ⑦ CIS Docker + ⑧ 런타임 탐지 (lab 6–9)           | 시험      |
| 3:10–3:30   | 실기 — 종합 감사 보고서: 준수율·갭·시정 로드맵 (lab 10)                        | 시험      |
| 3:30–3:40   | 정리 + 수료 안내 + 컨테이너 보안 운영자로서의 다음 단계                        | 정리      |
