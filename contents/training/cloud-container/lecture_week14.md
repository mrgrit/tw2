...
> 본 주차 lab(`lab_week14.yaml`)의 권장 학습 시간은 130 분이다. el34 에 실제 클라우드 계정이 없어
> 개념 정리·토론 중심으로 진행하므로, 시간표도 손 실습보다 **이론 + 사례 토론**의 비중이 크다.

| 시간        | 내용                                                                            | 유형      |
|-------------|---------------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 왜 CSPM 인가 (W13 오설정을 사람이 다 못 잡는다 · W09 의 클라우드 확장)     | 강의      |
| 0:20–0:45   | 이론 — CSPM 의 점검 항목(CIS Cloud Benchmark: IAM/스토리지/네트워크/암호화/로깅) | 강의      |
| 0:45–0:55   | 휴식                                                                            | —         |
| 0:55–1:20   | 이론 — 설정 드리프트 + IaC(Terraform) + auto-remediation                         | 강의/토론 |
| 1:20–1:40   | 이론 — 클라우드 감사 로깅(CloudTrail) = W06 감사 5요소의 클라우드판              | 강의      |
| 1:40–1:50   | 휴식                                                                            | —         |
| 1:50–2:05   | 이론 — CNAPP 통합(CSPM+이미지 W03+런타임 W10+k8s W12) + 미션 1~7 개념 정리       | 강의/실습 |
| 2:05–2:10   | 정리 + 채점 기준 안내 + 다음 주차(W15 — 기말 종합 감사) 예고                     | 정리      |
