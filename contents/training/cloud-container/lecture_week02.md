...
| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:25   | 이론 — 왜 "이미지가 곧 공격 표면"인가 (레이어·빌드타임·런타임의 연결)       | 강의      |
| 0:25–0:55   | 이론 — 이미지 레이어/히스토리 + 비밀 잔존 문제 (docker history)             | 강의      |
| 0:55–1:05   | 휴식                                                                        | —         |
| 1:05–1:35   | 이론 — 베이스 이미지·크기·노출 포트 = 표면의 세 척도 (el34 실측)            | 강의/토론 |
| 1:35–2:00   | 실습 — 점검(대상 도달) + 레이어/히스토리 (미션 1–2)                         | 실습      |
| 2:00–2:30   | 실습 — 베이스 이미지 + 이미지 크기 (미션 3–4)                               | 실습      |
| 2:30–2:40   | 휴식                                                                        | —         |
| 2:40–3:10   | 실습 — 노출 포트(EXPOSE 22) + 이미지 최소화 (미션 5–6)                      | 실습      |
| 3:10–3:30   | 실습 — 이미지 위생 방어 + 이미지 보안 보고서 (미션 7–8)                     | 실습      |
| 3:30–3:40   | 정리 + 채점 기준 안내 + 다음 주차(W03 — Trivy 이미지 취약점 스캔) 예고      | 정리      |
...
> **점검 경로.** el34 의 모든 컨테이너는 타깃 VM(192.168.0.151) 한 대 위에서 돈다. 점검자는 호스트에
