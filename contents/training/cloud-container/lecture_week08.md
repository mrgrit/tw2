...
중간고사는 시험이지만, 본 강의 시간은 시험 직전의 **종합 복습 + 판정 프레임워크 정립 + 실기 평가**로
구성한다.

| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 왜 항목 하나로는 컨테이너 보안을 못 판단하나 (기준선 감사의 필요)     | 강의      |
| 0:20–0:50   | 이론 — 기준선 표준(CIS Docker / NIST 800-190) + 점검표 8 항목 한눈에        | 강의      |
| 0:50–1:00   | 휴식                                                                        | —         |
| 1:00–1:30   | 이론 — el34-web 감사 지도(이미지·런타임·시크릿·네트워크·호스트 인터페이스)  | 강의/토론 |
| 1:30–2:00   | 실기 — 점검(대상) + ① 이미지 취약점 + ② 특권 + ③ capability (lab 1–4)       | 시험      |
| 2:00–2:30   | 실기 — ④ 실행 사용자 + ⑤ 시크릿 + ⑥ 격리 (lab 5–7)                          | 시험      |
| 2:30–2:40   | 휴식                                                                        | —         |
| 2:40–3:10   | 실기 — ⑦ 네트워크 + ⑧ docker.sock (lab 8–9)                                 | 시험      |
| 3:10–3:30   | 실기 — 종합 기준선 보고서(준수/갭/우선순위) 작성 (lab 10)                    | 시험      |
| 3:30–3:40   | 정리 + 채점 기준 안내 + 다음 주차(W09) 예고                                 | 정리      |
...
> **시험 진행 원칙.** 모든 명령은 el34 호스트(`ssh ccc@192.168.0.151`, 비밀번호 1)에서 `docker
