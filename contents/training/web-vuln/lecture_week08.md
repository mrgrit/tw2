...
중간고사는 시험이지만, 본 강의 시간은 시험 직전의 **종합 복습 + WSTG 방법론 정립 + 실기 평가**로
구성한다.

| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 점검자란 무엇인가, 왜 방법론(WSTG)으로 점검하는가                    | 강의      |
| 0:20–0:55   | 이론 — WSTG 한 바퀴: 정찰→인증→입력→접근제어→보고 + W01~W07 매핑           | 강의      |
| 0:55–1:05   | 휴식                                                                        | —         |
| 1:05–1:30   | 이론 — 표적 JuiceShop 의 구조 + el34 진입 경로(Host 헤더 vhost) 재확인     | 강의/토론 |
| 1:30–2:00   | 실기 — 점검(도달성) + ① 정찰(HTTP 메서드/정보 노출) (lab 1–2)              | 시험      |
| 2:00–2:30   | 실기 — ② 인증 우회(로그인 SQLi) + JWT 분석 (lab 3–4)                       | 시험      |
| 2:30–2:40   | 휴식                                                                        | —         |
| 2:40–3:10   | 실기 — ③ 입력 취약점(SQLi/XSS) + ④ 접근제어(무인증 관리/강제 브라우징) (lab 5–6) | 시험 |
| 3:10–3:30   | 실기 — 탐지 통합(WAF) + 심각도 평가 + 종합 보고 + 권고 (lab 7–10)          | 시험      |
| 3:30–3:40   | 정리 + 채점 기준 안내 + 다음 주차(W09 — 접근제어 심화) 예고                | 정리      |
