...
| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 수동 점검의 한계와 자동화의 등장(빠름 vs 정밀), 본 주차의 한 쌍 개념 | 강의      |
| 0:20–0:50   | 이론 — nuclei 의 구조: 템플릿(YAML 서명)이란 무엇인가 + dalfox / httpx 소개 | 강의      |
| 0:50–1:00   | 휴식                                                                        | —         |
| 1:00–1:30   | 이론 — 템플릿 설치의 사연: 왜 호스트 경유인가(컨테이너 egress 차단)         | 강의/실습 |
| 1:30–2:00   | 실습 — 점검(도달성) + nuclei 기술 탐지 + 보안 헤더 누락 (lab 1–3)           | 실습      |
| 2:00–2:30   | 실습 — HSTS 누락 확정(수동·자동 교차검증) + dalfox XSS(WAF 차단 관찰) (lab 4–5) | 실습   |
| 2:30–2:40   | 휴식                                                                        | —         |
| 2:40–3:10   | 실습 — 자동화의 한계 정리 + 방어(헤더/패치/CI-CD) (lab 6–7)                 | 실습/토론 |
| 3:10–3:30   | 실습 — 자동화 스캐닝 종합 보고서 (lab 8)                                    | 실습      |
| 3:30–3:40   | 정리 + 점검 수칙 + 다음 주차(W14 — 취약점 보고/위험 평가 CVSS) 예고         | 정리      |
