...
W14 는 분석·문서 중심이라 새 도구 설치가 없다. 강의 시간은 CVSS 산정 원리와 보고서 구조를 익히고,
W01~W13 의 발견을 실제로 평가·보고하는 실기로 구성한다.

| 시간        | 내용                                                                       | 유형      |
|-------------|----------------------------------------------------------------------------|-----------|
| 0:00–0:20   | 이론 — 왜 "발견"이 아니라 "전달"이 점검의 절반인가 (보고서가 산출물)        | 강의      |
| 0:20–1:00   | 이론 — CVSS 3.1 8개 메트릭 상세(AV·AC·PR·UI·S·C·I·A) + 벡터 읽고 쓰기       | 강의      |
| 1:00–1:10   | 휴식                                                                        | —         |
| 1:10–1:35   | 이론 — 심각도 등급 + 가능성×영향(OWASP Risk) 우선순위                       | 강의/토론 |
| 1:35–2:00   | 실기 — ① 발견 취합 + ② SQLi CVSS 벡터 구성 (lab 1–2)                        | 실습      |
| 2:00–2:30   | 실기 — ③ 심각도 분류 + ④ 가능성×영향 우선순위 (lab 3–4)                     | 실습      |
| 2:30–2:40   | 휴식                                                                        | —         |
| 2:40–3:10   | 실기 — ⑤ 증거(PoC) + ⑥ 권고 (lab 5–6)                                       | 실습      |
| 3:10–3:30   | 실기 — ⑦ Executive Summary + ⑧ 전문 보고서 (lab 7–8)                        | 실습      |
| 3:30–3:40   | 정리 + 채점 기준 안내 + 다음 주차(W15 — 기말 종합) 예고                     | 정리      |
